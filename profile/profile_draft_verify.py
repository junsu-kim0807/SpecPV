...
for seqlen in [1024, 4096, 8192, 16384, 32768]:
    ...
    # warmup
    for _ in range(5):
        _ = model.ea_generate(input_ids, temperature=0.8, max_new_tokens=128, max_length=40000)
    output = model.ea_generate(input_ids,temperature=0.8, max_new_tokens=1024, max_length=40000)
    # get results
    from sparsesd.speculate.utils import print_time_stats,reset_time_stats
    print("########### seqlen:", seqlen, "###########")
    print_time_stats()
    reset_time_stats()
